...
{
    /// <inheritdoc />
    public partial class relationTimeslots : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartTimeMins = table.Column<int>(type: "int", nullable: false),
                    EndTimeHours = table.Column<int>(type: "int", nullable: false),
                    EndTimeMins = table.Column<int>(type: "int", nullable: false),
                    DoctorId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AvailableTimings", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TimingSlots", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TimingSlots_Doctors_DoctorId",
                        column: x => x.DoctorId,
